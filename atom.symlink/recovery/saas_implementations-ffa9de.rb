      ...
      attributes_table_for saas_implementation do
        ...
        row "User Information" do
          metrics = [
            ...
            { name: "Walkadoo", users_metric: Metrics::Wd::Users, engaged_participants_metric: Metrics::Qn::EngagedParticipant},
            { name: "Well-Being ID", users_metric: Metrics::Pl::Users },
            { name: "Well-Being Tracker", users_metric: Metrics::Wbt::Users },
          ]
          table_for metrics do
            ...
            column "Engaged Users" do |m|
              value = m[:engaged_participants_metric].new([saas_implementation.segment], saas_implementation.starts_at).data_points.to_h["totalUsers"]
              status = case value
              when 0..1
                "red"
              when 2..5
