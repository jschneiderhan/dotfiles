...
export default Controller.extend({
  ...
  _createImplementation() {
    return this.get('store').query('saasImplementation', { filter: { user_id: 16} }).then( function(existingSaasImplementations){
      debugger;
      console.log(`existingSaasImplementations: ${existingSaasImplementations}`);
    });
