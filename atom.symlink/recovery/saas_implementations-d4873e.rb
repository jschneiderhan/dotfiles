    ...
    panel "Participation Information" do
      attributes_table_for saas_implementation do
        ...
        row "Enrolled Users" do
          metrics = [
            { name: "Daily Challenge", value: Metrics::Dc::Users.new([saas_implementation.segment], saas_implementation.starts_at).data_points.to_h["totalUsers"] },
            { name: "QuitNet", value: Metrics::Qn::Users.new([saas_implementation.segment], saas_implementation.starts_at).data_points.to_h["totalUsers"] },
            { name: "Wellbeing ID", value: Metrics::Pl::Users.new([saas_implementation.segment], saas_implementation.starts_at).data_points.to_h["totalUsers"] },
            { name: "Wellbeing Tracker", value: Metrics::Wbt::Users.new([saas_implementation.segment], saas_implementation.starts_at).data_points.to_h["totalUsers"] },
            { name: "Walkadoo", value: Metrics::Wd::Users.new([saas_implementation.segment], saas_implementation.starts_at).data_points.to_h["totalUsers"] }
          ]
