...
export default Controller.extend({
  ...
  actions: {
    ...
    login() {
      ...
      return this.get('ajax').request(`${ENV.APP.accountUrl}/api/user/session`, {
        ...
        // Commented out:
        //   - Works for existing WBID user without implementation
        //   - Error for existing WBID user with an implementation
        // Not Commented out:
        //   -
        this.get('session').load().then(() => { // When commented out:
          this._findOrCreateImplementation().then(() => {
  ...
  _findOrCreateImplementation() {
    return this.get('saasImplementationManager.saasImplementation').then((existingImplementation) => {
